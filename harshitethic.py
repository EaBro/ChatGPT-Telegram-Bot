...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6068452297:AAGBAo1D12jq-Mj78nMT6r5ak1s0D2vixJE"
else:
    tgkey = tgenv
print(tgenv)
